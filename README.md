...
## Introduction
This repository has taken definitions outlined in [Scikit-learn's Glossary](https://scikit-learn.org/stable/glossary.html) and put them into a form which can be easily learnt/revised using <a href="https://apps.ankiweb.net/">Anki</a> a cross platform app specifically designed for long term knowledge retention.

## Notes
Please note the modifications which have been made & where you can find updates.
1. The front of every card has "(Scikit-learn Glossary)" appended to the end so that if you have any other words in your collection, the Scikit-learn's Glossary definition will still be added when importing it.
...
4. Any updates, translations or corrections to the deck will be available at <a href="https://github.com/darigovresearch/Scikit-learn-Glossary-Flashcards/tree/main">https://github.com/darigovresearch/Scikit-learn-Glossary-Flashcards/tree/main</a> so do return periodically to check if you have the latest version.
...
This work was based on the ***Scikit-learn's Glossary*** by [scikit-learn developers](https://scikit-learn.org/stable/glossary.html). Content is available under a [BSD License](https://github.com/scikit-learn/scikit-learn/blob/main/COPYING).

To see this work in full go to https://scikit-learn.org/stable/glossary.html
